...
<!-- Login con FB -->
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v6.0&appId=621672211978515&autoLogAppEvents=1"></script>
<script>
  window.fbAsyncInit = function() {
    FB.init({
      appId      : '{621672211978515}',
      cookie     : true,
      xfbml      : true,
      version    : '{v6.0}'
    });
												...
												<div class="col-12">
													<div class="sign__content">
														...
														<form action="<?= ROOT_VIEW ?>/Login/verificarSesion" method="post" class="sign__form">
                                                            ...
                                                            <br>
                                                            <div class="fb-login-button" data-width="" data-size="small" data-button-type="continue_with" data-auto-logout-link="false" data-use-continue-as="false"></div>
                                                            </div> 
