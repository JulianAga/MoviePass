...
//----------------CONSTRUCTOR---------------------
	...
	public function index()
	{
		...
		{
			$_SESSION['Error']="Error index funcion controller";
		}
		...
		public function addFuncion($id_pelicula, $id_sala, $fecha, $hora)
		{
			...
			{
				$_SESSION['Error']="Error al agregar una funcion";
			}
	...
	public function deleteFunction($id_cine,$id_pelicula){
		...
		{
			$_SESSION['Error']="Error al borrar una funcion";
		}
	}//fin modify function
	...
	public function devolverFuncionesXidPelicula($id_pelicula){
		...
		{
			$_SESSION['Error']="Error al devolver funciones por id pelicula";
		}
	...
	public function contarEntradas($id_funcion)
	{
		...
		{
			$_SESSION['Error']="Error al contar entradas";
		}
